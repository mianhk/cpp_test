...
//	Sales_data &operator-(const Sales_data&,const Sales_data&);//重载的-运算符 
	...
	double get_avg_price() const {return avg_price();}
...
//	
//	is>>sales;
	fstream is("F:\\learn_cpp\\ch14\\data\\data1.txt");

	Sales_data sales;
	is>>sales;
	cout<<sales<<endl;
	string s;
	s=static_cast<string>(sales)+"abc";
	cout<<s<<endl;
	double d;
	cout<<sales.get_avg_price()<<endl;
	d=static_cast<double>(sales)+10;
	cout<<d<<endl;
//	string a("123456");
//	sales=a;
//	cout<<sales<<endl;
